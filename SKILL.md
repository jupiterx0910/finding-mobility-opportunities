...
Find businesses a specific operator can **actually enter, validate, survive, and own**.
...
Use `references/output-template.md` and return, in order:

1. Operator advantage / entrepreneur-archetype map
